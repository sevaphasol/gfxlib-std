...
fromSFML( sf::Mouse::Button button )
{
    ...
    {
        case sf::Mouse::Left:
            return MOUSECODE_LEFT;
        case sf::Mouse::Right:
            return MOUSECODE_RIGHT;
        case sf::Mouse::Middle:
            return MOUSECODE_MIDDLE;
        default:
            return MOUSECODE_UNKNOWN;
    }
}

dr4::KeyMode
fromSFML( sf::Event::KeyEvent event ) noexcept
{
    if ( event.alt )
    {
...
dr4::KeyCode
fromSFML( sf::Keyboard::Key code ) noexcept
{
    switch ( code )
    {
